...
urlpatterns = [
    ...
    path("app/configuracoes/empresa/", include("apps.tenants.urls")),
    path("app/configuracoes/usuarios/", include("apps.accounts.urls")),
    path("app/configuracoes/aparencia/", include("apps.branding.urls")),
